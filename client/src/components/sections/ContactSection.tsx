      ...
      <div className="h-screen w-full flex flex-col justify-center items-center min-[320px]:gap-10 sm:gap-20 z-2 absolute">
        ...
        >
          <div ref={downloadRef}>
            ...
            {/* Rubik font-black ашиглан кириллийг маш гоё зузаан харагдуулна, leading-normal-аар тайралтыг зассан */}
            <span className="font-rubik font-black tracking-normal min-[320px]:text-6xl sm:text-8xl md:text-9xl py-4 leading-normal uppercase block select-none">
              <Highlighter
                ref={highlightCV}
                color="#b778ff6c"
                action="highlight"
