...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-KX57FKO3.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-KX57FKO3.js")).default(client, args);
    case "add":
      return (await import("./add-L27WEHJQ.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-CBM636H7.js")).default(client, args);
    case "rm":
      return (await import("./rm-SUXZB6OT.js")).default(client, args);
    case "update":
      return (await import("./update-Q5CDTYFG.js")).default(client, args);
    default:
